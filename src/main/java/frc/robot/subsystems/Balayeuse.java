...
private TalonSRX m_Tourneshaft = new TalonSRX(kShaftBalayeuse);
   private DoubleSolenoid  m_pourstartdroit = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, kBalayeusePistonhautd, kBalayeusePistonhautg);
   private DoubleSolenoid  m_pourstartgauche = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, kBalayeusePistonbasd, kBalayeusePistonbasg);
